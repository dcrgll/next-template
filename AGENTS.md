...
Before adding a dependency or choosing an implementation approach, read [`docs/PREFERRED_LIBRARIES.md`](./docs/PREFERRED_LIBRARIES.md). It is based on the shared preferred-libraries list and adapted for this template — prefer those defaults over equivalent alternatives, and do not add a listed library if the repo already covers that job another way.
...
- Follow [`docs/PREFERRED_LIBRARIES.md`](./docs/PREFERRED_LIBRARIES.md) for default choices (Motion, Zod, React Hook Form, Zustand, TanStack Query, shadcn/ui, Better Auth, nuqs, Phosphor, Day.js, and related)
